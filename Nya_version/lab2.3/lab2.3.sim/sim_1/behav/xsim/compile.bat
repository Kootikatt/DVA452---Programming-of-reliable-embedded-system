...
REM
REM Generated by Vivado on Sun Jan 29 16:39:15 +0100 2023
...
echo "xvhdl --incr --relax -prj FI_TB_vhdl.prj"
call xvhdl  --incr --relax -prj FI_TB_vhdl.prj -log xvhdl.log
